    ...
    >
      <div className="w-full flex justify-between items-center max-w-7x1 mx-auto">
          ...
          >
            ...
            className="w-9
            h-9 object-contain" />
            <p className="text-white text-[18px] font-bold cursor-pointer flex">Jackson Trigiani &nbsp; <span className="sm:block hidden:"> | Aspiring Developer</span></p>
          </Link>
          ...
          justify-end items-center">
            ...
            top-20 right-0 mx-4 my-2 min-2-[140px] z-10 rounded-xl`}>
